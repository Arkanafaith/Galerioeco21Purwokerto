...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="link-row">
            ...
            <input type="url" name="social_google_maps_link" placeholder="maps.app.goo.gl/xxxxx" 
                   value="<?php echo e(old('social_google_maps_link', $googleMaps ?? '')); ?>" />
            <?php $__errorArgs = ['social_google_maps_link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span class="error"><?php echo e($message); ?></span> <?php unset($message);
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\ecoo21-main\ecoo21-main\resources\views/admin/social-settings.blade.php ENDPATH**/ ?>