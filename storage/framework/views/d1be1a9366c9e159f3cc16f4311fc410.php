...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('admin.products.store')); ?>" enctype="multipart/form-data">
        ...
        <div style="margin-bottom:10px">
            ...
            <input name="shopee_link" type="url" style="width:100%;padding:8px" placeholder="https://shopee.co.id/..." value="<?php echo e(old('shopee_link')); ?>">
        </div>
        <div style="margin-bottom:10px">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\ecoo21-main\ecoo21-main\resources\views/admin/products/create.blade.php ENDPATH**/ ?>