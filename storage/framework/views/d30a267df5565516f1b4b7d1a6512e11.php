...
<section class="hero">
    <div class="container">
        <div class="hero-content">
            ...
            <img src="<?php echo e(asset('images/icon/woman1_thumb.jpg')); ?>" alt="Pelanggan puas 1" width="36" height="36" loading="lazy" decoding="async">
            <img src="<?php echo e(asset('images/icon/woman2_thumb.jpg')); ?>" alt="Pelanggan puas 2" width="36" height="36" loading="lazy" decoding="async">
            <img src="<?php echo e(asset('images/icon/men_thumb.jpg')); ?>" alt="Pelanggan puas 3" width="36" height="36" loading="lazy" decoding="async">
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Downloads\ecoo21-main - Copy\ecoo21-main\resources\views/welcome.blade.php ENDPATH**/ ?>